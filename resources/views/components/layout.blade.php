                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                {{-- Acrescentar o : antes de uma prop informa ao laravel para tratar o valor como uma expressão e não uma string. --}}
                                {{-- O metodo request()->is() retorna um bool para caso a requisição seja feita ao parâmetro informado. --}}
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/179345425?v=4" alt="">
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="md:hidden" id="mobile-menu">
                    ...
                    <div class="border-t border-gray-700 pb-3 pt-4">
                        <div class="flex items-center px-5">
                            <div class="flex-shrink-0">
                                <img class="h-10 w-10 rounded-full" src="https://avatars.githubusercontent.com/u/179345425?v=4" alt="">
                            </div>
                            <div class="ml-3">
                                <div class="text-base font-medium leading-none text-white">Eduardo Alexandre</div>
                                <div class="text-sm font-medium leading-none text-gray-400">laravengineer@gmail.com</div>
                            </div>
